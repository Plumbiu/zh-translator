      ...
      ; (async () => {
        try {
          ...
          if (sourceLanguage !== SelectAutoDetectValue) {
            ...
            sendResponse({ type: TranslateTypeEnum.Translate, translation: translatorResult })
          } else {
          ...
          sendResponse({ type: TranslateTypeEnum.Translate, translation: error.message, error: true })
        }
      })()
  }
  return true
